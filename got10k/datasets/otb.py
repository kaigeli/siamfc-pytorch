...
class OTB(object):
    ...
    __football_seqs = [
                    ...
                    'football6', 'football7', 'football8', 'football9', 'football10',
                    'football11', 'football12', 'football13', 'football14','football15',
                    'football16', 'football17', 'football18', 'football19', 'football20',
                    'football21', 'football22', 'football23', 'football24']

    __otb15_seqs = __tb100_seqs

    __version_dict = {
        'football': __football_seqs,
        2013: __otb13_seqs,
        2015: __otb15_seqs,
    ...
    def __getitem__(self, index):
        ...
        elif seq_name.lower() == 'football1' and self.version != 'football':
